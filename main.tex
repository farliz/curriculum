...
\setupfootertexts[\Body Diciembre 2018][\Body Lizardo Reyna~\cdot~Curriculum Vitae]
...
\starttext
  ...
  \color[darkgray] {\Facultad Facultad de Ingeniería Agrícola, Universidad Técnica de Manabí}
       ...
       \symbol[fontawesome][envelope] {\from[me] \|  \symbol[fontawesome][envelope] \from[mee] \| \symbol[fontawesome][mobile] {\Mail +593 982924637}}
        \eTD
        \bTD [align={lohi}] {\externalfigure[qr][width=3.5cm]}  \eTD\eTR
    \eTABLE
  \stopTABLE
  ...
  \startTABLE[[background=color, frame=off]
    \bTABLE
    \bTR \bTD[align=right,width=4cm ]
     {\externalfigure [yo][width=3.5cm]}
        \eTD
        \bTD {\em 
...
\item Impacto de la mecanización en el cultivo de arroz sobre las propiedades físcas del
  suelo en la parroquia Charapotó. Maestría en Ingeniería Agrícola,  Universidad Técnica de Manabí, 2018 --- continúa.
...
\item Reyna-Bowen, L., {\BodyB Reyna-Bowen, M.}, Reina-Castro, J., \& Hurtado,
  ...
  Revista de Las Agrociencias. e-ISSN 2477-8982, 69–80.
    \item  Reyna-Bowen, L., {\BodyB Reyna-Bowen, M.}, \& Vera-Montengro, L. (2017). Zonificación del territorio para
    ...
    \item {\BodyB Reyna, L.}, Dube, F., Barrera, J. A., \& Zagal, E. (2017). Potential Model Overfitting in Predicting
    ...
    \item Castro, L. R., {\BodyB Reyna, L.}, \& Reyna-Bowen, L. (2014). Plan de desarrollo y ordenamiento territorial,
      como herramienta para el desarrollo sustentable: Estudio de caso en Esmeraldas, Ecuador. La Técnica,
      (12), 76–89.
    \item {\BodyB Reyna, L.}, \& Gossweiler, B. (2011). Segmentación y clasificación de imágenes
...
\startitemize
    ...
    \item Sustentabilidad de los sistemas agropecuarios en la zona del proyecto de riego
      Carrizal-Chone en Manabí, Ecuador. Primer congreso internacional sobre {\BodyB
        Efciencia en el uso del agua para la producción agrícola}. INACAP 2017, Chile.
\stopitemize
